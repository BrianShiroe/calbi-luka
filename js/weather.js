            ...
            currentWeatherContainer.innerHTML = `
                ...
                <div class="info-right">
                    <div class="weather-icon-right">
                        ${getWeatherIcon(latestData.condition)}
                    </div>
                </div>
            `;
        }
...
function getWeatherIcon(condition) {
    if (!condition) return `<img src="../img/weather-icons/sunny.svg" alt="Weather Icon">`;
    
    const conditionLower = condition.toLowerCase();
    
    if (conditionLower.includes("sunny")) return `<img src="../img/weather-icons/day.svg" alt="Sunny">`;
    if (conditionLower.includes("rain")) return `<img src="../img/weather-icons/rainy.svg" alt="Rain">`;
    if (conditionLower.includes("cloud")) return `<img src="../img/weather-icons/cloudy-day.svg" alt="Cloudy">`;
    if (conditionLower.includes("storm")) return `<img src="../img/weather-icons/thunder.svg" alt="Thunder">`;
    
    return `<img src="../assets/icons/partly-cloudy.svg" alt="Partly Cloudy">`;
}
